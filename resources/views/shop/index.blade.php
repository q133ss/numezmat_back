            ...
            <div class="page-header-wrap">
                <div class="page-header-left">
                    ...
                    <div class="page-title-block">
                        <div class="page-img">
                            <img src="/assets/img/why-coin.png" alt="">
                        </div>
                        <h3 class="page-title">
                            Магазин
                        </h3>
...
{{--                    <form action="{{route('shop.search')}}" method="GET" style="display: inline-block">--}}
            ...
            <div class="posts-page-wrap">
                <div class="posts-wrapper">
                    @can('create-sections-shop')
                        ...
                        <a href="{{route('shop.create.section')}}" class="comment-form-btn" style="display: block; margin-bottom: 20px; margin-top: 0;">Добавить новый раздел</a>
                    @endcan
                        ...
                        <div class="post-content catalog-post-content">
                            <div class="post-description">
                                ...
                                <div class="post-categories">
                                    @foreach(\App\Models\Category::getSubCategories('App\Models\Shop', $category->id, 4)->get() as $subCat)
                                    <a href="{{route('shop.show', $subCat->id)}}" class="post-category">
                                ...
                                <a href="{{route('shop.show', $category->id)}}" class="post-btn">Подробнее
                                    <img src="/assets/img/arrow-left.png" alt="">
                                </a>
                            </div>
                            <div class="post-info post-catalog-info">
                                    <span class="post-info-item">
                                        Разделы:  <span class="post-info-item-count">{{\App\Models\Category::getSubCategories('App\Models\Shop', $category->id, 1000)->count()}}</span>
                                    </span>
                            </div>
                        </div>
                    </div>
