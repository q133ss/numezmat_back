...
<div class="page-content">
    ...
    <section class="rating-show">
        <div class="container">
            <form action="{{route('expertise.update', $post->id)}}" id="edit-form" method="POST" enctype="multipart/form-data" class="search-wrap">
                @csrf
                @method('PUT')
