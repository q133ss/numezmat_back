...
<div class="page-content">
    ...
    <section class="rating-show">
        <div class="container">
            <form action="{{route($route)}}" id="edit-form" method="POST" enctype="multipart/form-data" class="search-wrap">
                @csrf
                ...
                <textarea name="description" class="search-request" cols="30" rows="10" style="display: block">{{old('description')}}</textarea>

                <button class="comment-form-btn" type="submit">Добавить</button>
            </form>
        </div>
    </section>
