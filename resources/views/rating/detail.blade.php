            ...
            <div class="page-header-wrap">
                <div class="page-header-left">
                    <ul class="breadcrumbs">
                        ...
                        @foreach($rating->category->getParents() as $category)
                            <li><a href="{{route('rating.show', $category)}}">{{$category->name}}</a></li>
                        @endforeach
                        <li><a href="{{route('rating.show', $rating->category->id)}}">{{$rating->category->name}}</a></li>
                        <li>{{$rating->title}}</li>
                    </ul>
        ...
        <div class="container">
            ...
            <div class="rating-show-wrapper">
                <div class="rating-show-content">
                    ...
                    @include('includes.comments', ['comments' => $rating->comments, 'type' => 'rating', 'postId' => $rating->id])
                ...
                <div class="rating-show-sidebar">
                    <div class="rating-show-sidebar-wrap">
                        ...
                        @foreach($rating->relatedPosts() as $post)
                        <div class="sidebar-other-theme">
                            ...
                            <a href="{{route('rating.detail', $post->id)}}" class="other-theme-btn">Подробнее</a>
                        </div>
                        @endforeach
                    </div>
                </div>
